  ...
  return (
        <div className="min-h-screen bg-gray-900 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row relative z-10">
            <DashboardSidebar />
            <MainContentWrapper>
              <div className="p-6 flex flex-col items-center justify-center min-h-[calc(100vh-200px)] relative z-10">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-4 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-xl p-4">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-gray-300 text-sm">Or browse our pre-built templates and community-made templates</span>
                </div>
                <div className="flex items-center space-x-3">
                  <button
                    onClick={() => setShowTemplateSection(!showTemplateSection)}
                    className="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/20"
                  >
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-emerald-600 to-teal-700 hover:from-emerald-700 hover:to-teal-800 text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg shadow-emerald-500/20"
                  >
                    <svg className="w-4 h-4 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {showTemplateSection && (
              <div className="animate-fadeIn">
                <div className="mb-6">
                  ...
                  <p className="text-gray-400">Select from our professional template collection</p>
                </div>
              <TemplateSelector 
