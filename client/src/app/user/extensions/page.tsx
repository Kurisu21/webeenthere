      ...
      <div className="flex flex-col md:flex-row">
        ...
        <MainContentWrapper>
          <div className="bg-gray-800 rounded-lg p-6">
            <h1 className="text-2xl font-bold text-white mb-4">✏️ Extensions & Plugins</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-700 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-white mb-2">🎨 Theme Extensions</h3>
                <p className="text-gray-300 text-sm mb-4">Customize your website appearance</p>
                <button className="w-full bg-pink-600 hover:bg-pink-700 text-white py-2 px-4 rounded-lg transition-colors">
                  Browse Themes
                </button>
              </div>
              <div className="bg-gray-700 rounded-lg p-4">
                <h3 className="text-lg font-semibold text-white mb-2">🔌 Functionality</h3>
                <p className="text-gray-300 text-sm mb-4">Add new features to your site</p>
              ...
              <div className="bg-gray-700 rounded-lg p-4">
                ...
                <p className="text-gray-300 text-sm mb-4">Create mobile app versions</p>
