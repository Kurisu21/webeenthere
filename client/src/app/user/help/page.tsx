    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Article Content */}
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg border border-gray-700 p-8 mb-8">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-lg"
            ...
            >
              <svg className="h-6 w-6 text-gray-400 hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </button>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 text-sm">Browse all help articles</p>
            </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {articles?.articles.map(article => (
                  ...
                  >
                    ...
                    <h3 className="text-white font-semibold mb-3 group-hover:text-purple-400 transition-colors">
                      {article.title}
                    </h3>
