      ...
      <div className="flex flex-col md:flex-row">
        ...
        <MainContentWrapper>
          <div className="bg-surface-elevated rounded-lg p-6">
            <h1 className="text-2xl font-bold text-primary mb-4">🎯 Problems & Goals</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-semibold text-primary mb-4">📋 Current Problems</h3>
              ...
              <div className="bg-surface rounded-lg p-4">
                <h3 className="text-lg font-semibold text-primary mb-4">🎯 Goals & Objectives</h3>
                <div className="space-y-3">
