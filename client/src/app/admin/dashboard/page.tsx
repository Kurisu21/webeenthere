        ...
        <MainContentWrapper>
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-surface-elevated rounded-xl border border-app p-4 sm:p-6 hover:border-blue-500/50 transition-all duration-300 shadow-lg hover:shadow-xl group cursor-pointer">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-sm sm:text-base text-primary font-medium group-hover:text-blue-400 transition-colors">Manage Users</h3>
                    <p className="text-xs sm:text-sm text-secondary">View and edit user accounts</p>
                  </div>
                </div>
              </div>

              <div className="bg-surface-elevated rounded-xl border border-app p-4 sm:p-6 hover:border-purple-500/50 transition-all duration-300 shadow-lg hover:shadow-xl group cursor-pointer">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-500/20 rounded-xl flex items-center justify-center group-hover:bg-purple-500/30 transition-colors flex-shrink-0">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-sm sm:text-base text-primary font-medium group-hover:text-purple-400 transition-colors">Role Management</h3>
                    <p className="text-xs sm:text-sm text-secondary">Assign and manage user roles</p>
                  </div>
                </div>
              </div>

              <div className="bg-surface-elevated rounded-xl border border-app p-4 sm:p-6 hover:border-green-500/50 transition-all duration-300 shadow-lg hover:shadow-xl group cursor-pointer sm:col-span-2 lg:col-span-1">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-sm sm:text-base text-primary font-medium group-hover:text-green-400 transition-colors">View Analytics</h3>
