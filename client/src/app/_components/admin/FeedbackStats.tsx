    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-primary">Loading statistics...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-primary text-lg font-medium mb-2">Error Loading Statistics</p>
          <p className="text-secondary">{error || 'No data available'}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-surface-elevated rounded-lg border border-app p-6">
        ...
        <div>
          <p className="text-3xl font-bold text-primary mb-2">{stats.open}</p>
      ...
      <div className="bg-surface-elevated rounded-lg border border-app p-6">
        ...
        <div>
          <p className="text-3xl font-bold text-primary mb-2">{stats.closed}</p>
      ...
      <div className="bg-surface-elevated rounded-lg border border-app p-6">
        ...
        <div>
          <p className="text-3xl font-bold text-primary mb-2">{stats.averageResponseTime}h</p>
          <p className="text-secondary text-sm">Avg Response Time</p>
        </div>
      </div>

      {/* Feedback by Type */}
      <div className="md:col-span-2 bg-surface-elevated rounded-lg border border-app p-6">
        <h3 className="text-lg font-semibold text-primary mb-4">Feedback by Type</h3>
      ...
      <div className="md:col-span-2 bg-surface-elevated rounded-lg border border-app p-6">
        <h3 className="text-lg font-semibold text-primary mb-4">Feedback by Priority</h3>
        <div className="space-y-3">
          {Object.entries(stats.byPriority).map(([priority, count]) => (
            <div key={priority} className="flex items-center justify-between">
              <span className="text-secondary capitalize">{priority}</span>
              <div className="flex items-center gap-2">
                <div className="w-32 bg-surface rounded-full h-2">
                  <div 
