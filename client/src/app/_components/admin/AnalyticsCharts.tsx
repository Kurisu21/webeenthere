...
export default function AnalyticsCharts({
  ...
  const renderChart = () => {
    switch (type) {
      case 'line':
        return (
          <LineChart data={data}>
            <CartesianGrid strokeDasharray="3 3" stroke="var(--app)" opacity={0.5} />
            <XAxis 
              dataKey={xAxisKey} 
  ...
  if (!data || data.length === 0) {
    return (
      <div className={`flex items-center justify-center bg-surface-elevated rounded-lg border border-app ${className}`} style={{ height }}>
