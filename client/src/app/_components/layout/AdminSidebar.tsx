...
const AdminSidebar = memo(() => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-0 z-40 bg-surface-elevated/80 backdrop-blur-sm text-primary flex flex-col h-screen py-4 md:py-8 px-4 border-r-0 md:border-r border-app/50 shadow-2xl transition-all duration-300 ease-in-out
        ${isCollapsed 
          ? 'w-16 md:w-16' 
          : 'w-full md:w-64'
        }
