...
interface BuilderToolbarProps {
  websiteTitle: string;
  showStockAssets: boolean;
  showLayers: boolean;
  showPreview: boolean;
  isCreating: boolean;
  onShowStockAssets: () => void;
  onToggleLayers: () => void;
    ...
    <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between shadow-sm">
      <div className="flex items-center space-x-6">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-gray-900 dark:text-white font-semibold text-lg">Website Builder</span>
        </div>
        <div className="text-sm text-gray-500 dark:text-gray-400">Building: {websiteTitle || 'Untitled Website'}</div>
      </div>
      
      <div className="flex items-center space-x-3">
        <button
          onClick={onShowStockAssets}
        ...
        <button
          ...
          disabled={isCreating}
          className="px-6 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white rounded-lg transition-colors flex items-center space-x-2 font-medium"
        >
          {isCreating ? (
            <>
