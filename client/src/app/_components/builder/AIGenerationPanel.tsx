    ...
    <div className={`${professionalTheme.bg} border ${professionalTheme.border} rounded-xl p-8 mb-8 shadow-2xl ${professionalTheme.shadow}`}>
      ...
      <div className="max-w-6xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className={`bg-gray-700/50 backdrop-blur-sm border ${professionalTheme.border} rounded-xl p-6`}>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                  <textarea
                    ...
                    className={`w-full min-h-[48px] max-h-[200px] px-4 py-3 bg-transparent text-white placeholder-gray-400 focus:outline-none resize-none text-lg focus:ring-2 focus:ring-blue-500 overflow-hidden`}
                    rows={1}
                  />
              </div>
              ...
              <button
                ...
                className={`p-3 bg-gradient-to-r ${professionalTheme.primary} hover:opacity-90 disabled:bg-gray-600 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg ${professionalTheme.shadow}`}
              >
                {isGenerating ? (
          ...
          <div className="flex justify-center space-x-8">
            <div className="flex items-center space-x-3">
              <label className={`${professionalTheme.text} text-sm font-semibold`}>Type:</label>
              <div className="relative">
                <select
                  value={websiteType}
                  onChange={(e) => setWebsiteType(e.target.value)}
                  className={`px-4 py-2 bg-gradient-to-r from-gray-700/80 to-gray-800/80 backdrop-blur-sm border ${professionalTheme.border} rounded-xl text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 hover:from-gray-600/80 hover:to-gray-700/80 cursor-pointer appearance-none pr-8`}
                >
            ...
            <div className="flex items-center space-x-3">
              <label className={`${professionalTheme.text} text-sm font-semibold`}>Style:</label>
              <div className="relative">
                <select
                  value={style}
            ...
            <div className="flex items-center space-x-3">
              <label className={`${professionalTheme.text} text-sm font-semibold`}>Colors:</label>
              <div className="relative">
                <select
                  value={colorScheme}
