      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
          ...
          {activeTab === 'preview' ? (
            <div className="space-y-6">
              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-8">
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg mx-auto max-w-4xl overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
          <div className="text-sm text-gray-600 dark:text-gray-400">
            This template includes {template.elements?.length || 0} pre-designed elements
          </div>
