    ...
    <div className={`flex flex-col h-screen ${bgPrimary}`}>
      ...
      <div className={`flex items-center justify-between p-4 ${bgSecondary} border-b ${borderColor}`}>
        ...
        <div className="flex items-center space-x-2">
          {/* Toolbar Controls */}
          <div className="flex items-center space-x-1 mr-2 px-2 border-r border-gray-600">
            <button
              onClick={handleUndo}
              className="px-2 py-2 text-gray-300 hover:text-white hover:bg-gray-700 rounded transition"
              title="Undo"
            >
          ...
          <div className="flex items-center space-x-1 mr-2 px-2 border-r border-gray-600">
            <button
              ...
              className={`px-3 py-2 rounded transition ${activeDevice === 'desktop' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700'}`}
              title="Desktop"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className={`px-3 py-2 rounded transition ${activeDevice === 'tablet' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700'}`}
              title="Tablet"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className={`px-3 py-2 rounded transition ${activeDevice === 'mobile' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-white hover:bg-gray-700'}`}
              title="Mobile"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="p-4 space-y-4">
            ...
            <div className={`mt-8 p-4 ${bgTertiary} rounded border ${borderColor}`}>
              ...
              <textarea
                ...
                className={`w-full h-32 ${inputBg} ${textPrimary} border ${borderColor} rounded p-2 font-mono text-sm`}
                placeholder="Add custom CSS here... (e.g., .my-class { color: red; })"
              />
